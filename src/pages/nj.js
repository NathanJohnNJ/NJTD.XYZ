                ...
                <div className="aboutTopLeft">
                    ...
                    <span className="boxContent">
                        ...
                        <div className="aboutTopMiddle">
                            <Typewriter 
                            words={[" And I hate to be put in a box..."]}
                            typeSpeed="50"
                            delaySpeed="1300"
                            />
                        </div>
                        <div className="aboutTopRight">
                            <p>
                                <Typewriter 
                                words={[" ...but try as I might if you're reading this, you're probably going to be categorising me in some way. So if you insist on putting me in a box, can you at least make it pink, and fun, and unexpectedly delightful? Thanks!"]}
                                typeSpeed="1000"
                                delaySpeed="1800"
                                />
                            </p>
