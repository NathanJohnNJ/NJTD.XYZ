...
const Nj = () => {
  ...
  onInit={(typewriter) => {
    ...
    function second(){
        <Typewriter
  onInit={(typewriter) => {
    typewriter.typeString("And I hate to be put in a box... ")
    ...
    function third(){
        <Typewriter
  onInit={(typewriter) => {
    typewriter.typeString(" ...but try as I might if you're reading this, you're probably going to be categorising me in some way. So if you insist on putting me in a box, can you at least make it pink, and fun, and unexpectedly delightful? Thanks! ")
        ...
        <div className="njcodes">
            ...
            >
                ...
                <div className="aboutTopRight">
                    <p>
                            ...but try as I might if you're reading this, you're probably going to be categorising me in some way. So if you insist on putting me in a box, can you at least make it pink, and fun, and unexpectedly delightful? Thanks!
                    </p>
                </div>
            </div>
